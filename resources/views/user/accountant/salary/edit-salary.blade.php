        ...
        <div class="container-fluid">
            <div class="row mx-lg-5 mx-md-0">
                <x-breadcrumb :links="[
                    ...
                    ['url' => route('salary.edit', $salary->id), 'label' => 'Edit Salary'],
                ]" />
            </div>
                        ...
                        <form action="{{ route('salary.update', $salary) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="staff_id" id="staff_id" class="form-control">
                                    <option value="{{ $salary->user->id }}">{{ $salary->user->name }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <label id="totalSalary" name="totalSalary" value="{{  old('totalSalary') }}"> {{  $salary->total_salary }}</label>
                            </div>
